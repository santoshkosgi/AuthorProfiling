...
public class MergerAge{
	static String sourcPath = "/home/santosh/Downloads/AP/Experiment1/index/Age/";
	public static void main(String argv[]) throws IOException{
		//InputStream is = new BufferedInputStream(new FileInputStream("/home/santoshkosgi/Downloads/Wiki/out2/1.txt"));
		MergerAge mergeGender = new MergerAge();
		mergeGender.mergeAge(sourcPath);
	}

	public void mergeAge(String sourcePath) throws IOException{
		InputStream    fis;
		BufferedReader br;
		InputStream    fis1;
		BufferedReader br1;
				...
				for (int i = 0; i <listOfFiles.length; i=i+2) {
						...
						while(true){
							if(first.split("\\|")[0].compareTo(second.split("\\|")[0])<0){
								...
								int third_int = Integer.parseInt(first_str.split("@")[2])+Integer.parseInt(second_str.split("@")[2]);
								output.append(first.split("\\|")[0]+"|"+first_int+"@"+second_int+"@"+third_int+"\n");
								first=br.readLine();
								second=br1.readLine();
